...
import { About, CustomHead, Experience, Home, Loader, More, Particles, Projects } from 'components';
			...
			<>
				...
				<section className='section' {...handlers}>
					...
					<AnimatePresence exitBeforeEnter>
						...
						{page.no === 4 && (
							<Projects {...{ exitLeft, setExitLeft, page, setPage }} key='projects' />
						)}
						{page.no === 5 && <More {...{ exitLeft, setExitLeft, page, setPage }} key='more' />}
					</AnimatePresence>
				</section>
			</>
		</>
